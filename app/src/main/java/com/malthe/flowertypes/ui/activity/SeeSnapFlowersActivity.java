...
public class SeeSnapFlowersActivity extends AppCompatActivity implements ImageUtils.ImageClassificationListener, FlowerActionHandler.ActionCallback, LocationListener {
    ...
    private void navigateToDetailActivity(Flower flower) {
        Intent intent = new Intent(SeeSnapFlowersActivity.this, DetailActivity.class);
        intent.putExtra("documentId", flower.getDocumentId());
        startActivity(intent);
    }

    private void navigateToMapsActivity() {
        Intent intent = new Intent(SeeSnapFlowersActivity.this, MapsActivity.class);
        startActivity(intent);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_LOCATION_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                initializeLocationManager();
                ImageUtils.handlePermissionsResult(this, requestCode, permissions, grantResults, () -> ImageUtils.openCamera(SeeSnapFlowersActivity.this));
            } else {
    ...
    public void onActionSuccess(String message) {
        ...
        Toast toast = Toast.makeText(SeeSnapFlowersActivity.this, message, Toast.LENGTH_SHORT);
    ...
    public void onActionFailure(String error) {
        Toast toast = Toast.makeText(SeeSnapFlowersActivity.this, error, Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 300);
        toast.show();
    }
}
